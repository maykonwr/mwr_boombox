        ...
        <div className="navbar">
            ...
            <div className="controlSong">
                ...
                <div className="slider-container">
                    ...
                    <Slider id="timeVideo" color="red" size="xs" showLabelOnHover={false} value={value} max={maxDuration} onChange={changeTime} onChangeEnd={syncTime} />
                    <div className="time-display">
            ...
            <div className="controlDistVol">
                ...
                <div className="volume">
                    <div style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
                        ...
                        <div>
                            <Slider color="red" size="xs" showLabelOnHover={false} min={2} max={50} className="volumeSLider" value={distReproActive} onChangeEnd={(event)=>{changeDist(event)}} onChange={(event)=>{setDistReproActive(event)}} />
                        </div>
                    </div>
                </div>
            </div>
