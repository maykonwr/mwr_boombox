...
export default function DisplayPlaylist({Playlists, playlistActive, playSong, exitPlaylist, setOpenedPlaylist}:Props) {
    ...
    const [titleFirstMessage, setTitleFirstMessage] = useState("Ainda não tem uma playlist?");
    const [secondFirstMessage, setSecondFirstMessage] = useState('Crie uma Playlist');
